      ...
      <div className="flex items-center">
        ...
        <div className="mx-auto text-sm font-medium px-2 py-1">
          <img
            ...
            src={terminalIcon}
          />
          <span className="inline-block align-middle">AnilKumar - - zsh</span>
        </div>
      </div>
    );
  };
      ...
      <div className="p-2 h-[500px]">
        ...
        <div className="flex flex-col gap-2 mt-3">
          <div className="font-mono ml-3">
            ...
            <span>-&gt; </span>
            <a
              href="https://www.linkedin.com/in/kotyada-anil-kumar-862a28280/"
              className="text-xs"
            >
              www.linkedin.com/in/kotyada-anil-kumar-862a28280
            </a>
          </div>
          <div className="font-mono ml-3">
            <img loading="lazy" src={EmailIcon} className="inline-block mr-3" />
            <span>-&gt; </span>
            <a href="mailto:anilkumarkotyada95@gmail.com" className="text-xs">
              anilkumarkotyada95@gmail.com
            </a>
          </div>
          <div className="font-mono ml-3">
            <img
          ...
          <div className="">
            <div className="text-xs font-mono mt-7 flex items-center justify-between">
              <p className="w-[220px]">Anil@Kotyada-MacBook ~ %</p>
              <input
                type="text"
